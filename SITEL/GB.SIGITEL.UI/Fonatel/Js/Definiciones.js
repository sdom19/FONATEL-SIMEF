...
var urlAPI = jsconstantes.variables.direccionApi+'CatalogoIndicadores/'; // Acá se cambia el url del api
var urlAPIConsulta = jsconstantes.variables.direccionApi+ 'DescargaIndicadores/'; // Acá se cambia el url del api


jQuery(document).ready(function () {

    MostrarTituloPantalla("#tituloCatalogo", 6);
    MostrarSubTituloPantalla("#descripcionCatalogo", 6)
    MostrarTextoImagen("#contenidoCatalogo", 6)
