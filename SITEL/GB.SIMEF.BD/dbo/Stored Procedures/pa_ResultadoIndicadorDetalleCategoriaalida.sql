...
CREATE PROC [dbo].[pa_ResultadoIndicadorDetalleCategoriaalida]

 @IdFormulaCalculo INT,
 @IdIndicadorResultado UNIQUEIDENTIFIER
AS
-- =============================================
...
(
	...
	AND b.Estado=1
	WHERE a.IdFormulaCalculo=@IdFormulaCalculo
...
(
	...
	AND c.IdCategoriaDesagregacion=a.IdCategoriaDesagregacion
...
AS
(
	SELECT DISTINCT @IdIndicadorResultado IdIndicadorResultado, b.IdCategoriaDesagregacion,b.TipoCategoria,b.Valor,b.NumeroFila,c.IndicadorEntrada IndicadorReferencia, 1 Estado, GETDATE() FechaCreacion
...
ON (SOURCE.IdIndicadorResultado=TARGET.IdIndicadorResultado
...
WHEN MATCHED THEN 
	...
	Valor=SOURCE.Valor;
	 ...
	 WHERE IdIndicadorResultado=@IdIndicadorResultado;