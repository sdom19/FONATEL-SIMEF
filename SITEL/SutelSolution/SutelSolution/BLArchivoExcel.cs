    ...
    public class BLArchivoExcel
    {
        ...
        public DetalleAgrupacionSP consultarReglaParaIndicador(List<DetalleAgrupacionSP> objRespuesta, string nombre)
        {
          ...
          //  obj = objRespuesta.Where(x => x.Nombre_Detalle_Agrupacion.Trim() == nombre.Trim() && x.Id_Padre_ConstructorCriterio != null && x.Id_Tipo_Valor != null ).FirstOrDefault();
           ...
           obj = objRespuesta.Where(x => x.Nombre_Detalle_Agrupacion.Trim() == nombre.Trim() && x.Id_Padre_ConstructorCriterio != null && x.Id_Tipo_Valor != null && x.Valor_Superior != null && x.Valor_Inferior != null ).FirstOrDefault();
        ...
        public void aplicarReglaCellNumerico(ExcelWorksheet worksheet, string cell, int minValue, Int64  maxValue)
        {
            ...
            validation.Formula2.Value = 999999999; 
        }
