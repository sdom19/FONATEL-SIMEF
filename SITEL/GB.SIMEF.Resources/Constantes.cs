...
namespace GB.SIMEF.Resources
{
    public static class Constantes
    {
        ...
        public struct EstructuraHtmlRegistroIdicador
        {
            ...
            public const string InputAlfanumerico = "<td><input type='text' aria-label='{0}' class='form-control form-control-fonatel alfa_numerico' id='[0]-{1}' placeholder='{0}' style='min-width:150px;'></td>";
            public const string InputTexto = "<td><input type='text' aria-label='{0}' class='form-control form-control-fonatel solo_texto' id='[0]-{1}' placeholder='{0}' style='min-width:150px;'></td>";
            public const string InputFecha = "<td><input type='date' class='form-control form-control-fonatel' id='[0]-{0}' min='{1}' max='{2}'></td>";
            public const string InputNumerico = "<td><input type='number' class='form-control form-control-fonatel solo_numeros' id='[0]-{0}' min='{1}' max='{2}'></td>";
