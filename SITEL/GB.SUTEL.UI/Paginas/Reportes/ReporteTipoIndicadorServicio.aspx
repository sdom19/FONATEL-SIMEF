<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteTipoIndicadorServicio.aspx.cs" Inherits="GB.SUTEL.UI.Paginas.Reportes.ReporteTipoIndicadorServicio" %>
...
<body>
    <h4>Reporte de Tipos de Indicador por Servicio</h4>
        ...
        <div>
            <div class="form-horizontal">
                ...
                <br />
                 ...
                 <br />
                <div class="form-group">
                    <asp:Label ID="lblTipoIndicador" runat="server" Text="Tipos Indicador" CssClass="control-label col-md-2"></asp:Label>
                    <div class="col-md-10">

                         <asp:DropDownList ID="ddlTipoIndicador" runat="server" AutoPostBack="true" CssClass="form-control"
                             DataTextField="DesTipoInd" DataValueField="IdTipoInd" OnDataBound="ddlTipoIndicador_DataBound" ></asp:DropDownList>
