        ...
        "CargarTablaRelacion": function () {
            ...
            for (var i = 0; i < JsRelacion.Variables.ListadoRelaciones.length; i++) {
                ...
                if (detalle.DetalleRelacionCategoria.length == 0) {
                    ...
                    html = html + "<button type='button' data-toggle='tooltip' data-placement='top' value=" + detalle.id + " data-original-title='Descargar Plantilla' title='Descargar Plantilla' class='btn-icon-base btn-download'></button>" +

                        "<td><button type ='button' data-toggle='tooltip' data-placement='top' value=" + detalle.id + "  data-original-title='Cargar Detalle'  title='Cargar Detalle' class='btn-icon-base btn-upload' ></button >" +
