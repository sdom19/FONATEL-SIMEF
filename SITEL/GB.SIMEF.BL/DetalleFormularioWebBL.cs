...
namespace GB.SIMEF.BL
{
    public class DetalleFormularioWebBL : IMetodos<DetalleFormularioWeb>
    {
        ...
        //private bool ValidarCantidadIndicadores(int id)
        //{
        //    FormularioWeb objeto = new FormularioWeb();
        //    objeto.idFormulario = id;
        ...
        public RespuestaConsulta<List<DetalleFormularioWeb>> InsertarDatos(DetalleFormularioWeb objeto)
        {
            try 
            {
                ...
                //if (ValidarDatosRepetidos(objeto) && ValidarCantidadIndicadores(objeto.idFormulario)) 
